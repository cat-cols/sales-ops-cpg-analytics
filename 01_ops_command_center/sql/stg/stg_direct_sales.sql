-- sql/stg/stg_direct_sales.sql
-- Direct-to-retailer sales staging view (manufacturer to retailers)
-- New view for manufacturer model
-- Raw source: raw.direct_sales_extract
-- Output: stg.stg_direct_sales

create schema if not exists stg;

create or replace view stg.stg_direct_sales as
with base as (
    select
        -- lineage
        load_id,
