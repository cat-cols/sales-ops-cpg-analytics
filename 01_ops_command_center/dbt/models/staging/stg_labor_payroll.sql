-- Standardize weekly payroll export into a typed staging model; normalize dept/team labels; add missing dept/team flag.
...
with base as (
    select
        ...
        labor_cost,
        labor_cost_raw
    from {{ source('raw', 'labor_hours_payroll_export') }}
),
casted as (
    select
        load_id,
