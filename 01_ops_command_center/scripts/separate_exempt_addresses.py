#!/usr/bin/env python3
"""
Separate exempt addresses from parsed recreational retailer data
"""

import csv

input_file = '/Users/b/data/projects/althea-sales-ops-cpg/data/reference/or_licenses/derived/recreational_retailer_parsed.csv'
...
for row in exempt_rows[:3]:
    print(f"  {row['license_number']}: {row['business_name']} - {row['raw_physical_address']}")
